        ...
        for num_of_sentence, sentence in enumerate(raw_train_set):
            ...
            for tagged_word in train_set_as_strings:
                try:
                    ...
                    continue
                if word not in unigram_features_as_dictionary.keys():
                    unigram_features_as_dictionary[word] = [(tag, num_of_sentence),]
                else:
                    unigram_features_as_dictionary[word].append((tag, num_of_sentence),)
